...
foo = makeHFA("foo", makeTransition(
		...
		[start] = printA,
		[printA] = printB, 
		[printB] = function() print("counter is " .. tostring(foo.counter)); return bumpCounter end,
		[bumpCounter] = function() if(foo.counter > 5) then return done else return printA end end;
	}))
