...
-- added by Chau ----
function reset_stance()
  qLArm0=math.pi/180*vector.new({90,8,-20});
  qRArm0=math.pi/180*vector.new({90,-8,-20});
  bodyTilt=20*math.pi/180;

  Config.walk.qLArm = qLArm0;
  Config.walk.qRArm = qRArm0;
  Config.walk.bodyTilt = bodyTilt;
end

function keep_holding_high() 
  qLArm0 = math.pi/180*vector.new({-85,-15,-20});
  qRArm0 = math.pi/180*vector.new({-85,15,-20});
  bodyTilt = 10*math.pi/180;
end
